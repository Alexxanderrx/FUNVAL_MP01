...
<body class=" h-screen   flex  justify-center align-items-center">
    <div class="flex flex-col  justify-center align-items-center h-full w-screen  md:w-96 ">
        <form
            class="flex-col h-full md:h-[560px]  w-full md:w-96 p-4 md:p-10 border-0 md:border border-gray-400 rounded-3xl"
            name="formularioSingUp" method="post" action="infoHall.php">
        ...
        <div class="flex align-items-center justify-between px-4 md:px-0">
