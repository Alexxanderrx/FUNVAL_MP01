...
<body class=" h-screen   flex  justify-center align-items-center">
    <div class="flex flex-col  justify-center align-items-center h-full w-screen  md:w-96 ">
        <form class="flex-col h-full md:h-[560px]  w-full md:w-96 p-4 md:p-10 border-0 md:border border-gray-400 rounded-3xl" name="formularioSingUp" method="post" action="infoHall.php">

            <img class="mb-4" src="./imgs/devchallenges.svg" alt="devchallenges.svg" />

            <p style="font-family: 'Noto Sans', sans-serif;" class="mb-4 font-semibold ">Join thousands of
                learners
                from around the world</h4>
            <p style="font-family: 'Noto Sans', sans-serif;" class="mb-5 text-sm">Master web development by making
                real-life projects. There are multiple paths for
                you to
                choose</p>
            <div>
            ...
            <p style="font-family: 'Noto Sans', sans-serif;" class="flex text-xs text-gray-500 justify-center">or
            ...
            <div class="flex text-sm justify-center">
                <p class="text-gray-500 text-xs">Already a member?</p>
                <p class=" text-sky-500 text-xs"><a href="./login.php">&#160;Login</a></p>
            </div>
